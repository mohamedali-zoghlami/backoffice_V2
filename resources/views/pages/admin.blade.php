            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Gestion des administrateurs</h4>
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item active">Connexions > Administrateurs</li>
                            </ol>
                        </div>
                            ...
                            <div class="listjs-table" id="customerList">
                                <div class="row g-4 mb-3">
                                    <div class="col-sm-auto">
                                        <div>
                                            <button type="button" class="btn btn-primary add-btn" onclick="userCreate()" data-bs-toggle="modal" id="create-btn" data-bs-target="#showModal"><i class="ri-add-line align-bottom me-1"></i> Ajouter un admin</button>
                        ...
                        <form class="tablelist-form" id="formUser" method="POST">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="name" name="name" maxlength="255" class="form-control" placeholder="Entrer le nom" required />
                                    <div class="invalid-feedback">Entrer le nom de l'utilisateur</div>
                                </div>

                                <div class="mb-3">
                                    <label for="email" class="form-label">Email</label>
                                    <input type="email" id="email" name="email" maxlength="255" class="form-control" placeholder="Entrer L'email" required />
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body d-flex justify-content-center align-items-center">
                                ...
                                <form action="/excel" class="m-4" method="POST">
                                    @csrf
                                    <input name="source" value="admin" hidden>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="mt-2 text-center">
                                ...
                                <h4>Êtes vous sûr ?</h4>
                                    <p class="text-muted mx-4 mb-0">Êtes vous sûr de vouloir supprimer cet administrateur ?</p>
                                </div>
                            </div>
...
$(document).ready(function() {
        ...
        userDelete=function(id)
            ...
            userCreate=function()
            {  document.getElementById("formUser").action="/admin/create";
                document.getElementById("name").value="";
                document.getElementById("email").value="";
                document.getElementById("role").selectedIndex=0;
                document.getElementById("operateur_id").selectedIndex=0;
            }
            userUpdate=function(form){
                document.getElementById("formUser").action="/admin/update";
                ...
                document.getElementById("role").value=form.role;
                selectElement=document.getElementById("operateur_id");
                for (var i = 0; i < selectElement.options.length; i++) {
                if (parseInt(selectElement.options[i].value) === form.operateur_id) {
