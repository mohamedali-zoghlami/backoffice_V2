<div @if(session()->has("fichier")||session()->has("intern")||session()->has("pdf"))style="display: none"@endif>
        ...
        <tbody class="list form-check-all">
            ...
            <tr>
                ...
                <td>
                    <div class="d-flex gap-2">
                        <div class="edit">
                            <button class="btn btn-sm btn-primary edit-item-btn" onclick="download({{json_encode($fichier->id)}},'data')" >Télécharger</button>
                        </div>
                        <div class="remove">
            ...
            <tbody class="list form-check-all">
                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex gap-2">
                            <div class="edit">
                                <button class="btn btn-sm btn-primary edit-item-btn" onclick="download({{json_encode($file->id)}},'pdf')" >Télécharger</button>
                            </div>
                        </div>
                    </td>
                </tr>
