            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Gestion des Domaines</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item active">Paramètres > Domaines</li>
                            </ol>
                        </div>
                            ...
                            <div class="listjs-table" id="customerList">
                                <div class="row g-4 mb-3">
                                    <div class="col-sm-auto">
                                        <div>
                                            <button type="button" onclick="createDomaine()" class="btn btn-primary add-btn" data-bs-toggle="modal" id="create-btn" data-bs-target="#showModal"><i class="ri-add-line align-bottom me-1"></i> Ajouter</button>
            ...
            <div class="modal fade" id="showModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <form class="tablelist-form" id="formDomaine" autocomplete="off" method="POST">
                            @csrf
                            <div class="modal-body">
                                ...
                                <div class="mb-3">
                                    <label for="customername-field" class="form-label">Nom du domaine</label>
                                    <input type="text" id="name" name="name" maxlength="255" class="form-control" placeholder="Entrer le nom du domaine" required />
                                    <div class="invalid-feedback">Entrer le nom du domaine</div>
                                </div>
                            </div>
                            <div class="modal-footer">
                                <div class="hstack gap-2 justify-content-end">
                                    <button type="button" class="btn btn-light" data-bs-dismiss="modal">Fermer</button>
                                    <button type="submit" id="submitDomaineButton" class="btn btn-success" id="add-btn"></button>
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4>Télécharger les domaines en fichier :</h4>
                        ...
                        <div class="modal-body d-flex justify-content-center align-items-center">
                                ...
                                <form action="/excel" class="m-4" method="POST">
                                    @csrf
                                    <input name="source" value="domaines" hidden>
                        ...
                        <div class="modal-body">
                            <div class="mt-2 text-center">
                                ...
                                <div class="mt-4 pt-2 fs-15 mx-4 mx-sm-5">
                                    <h4>Êtes vous sûr ?</h4>
                                    <p class="text-muted mx-4 mb-0">Êtes vous sûr de vouloir supprimer ce domaine ?</p>
                                </div>
                            </div>
                            <div class="d-flex gap-2 justify-content-center mt-4 mb-2">
                                <button type="button" class="btn w-sm btn-light" data-bs-dismiss="modal">Annuler</button>
                                <form action="{{route('domaine.delete')}}" method="POST">
                                    @csrf
                                <input type="text" name="idDomaine" id="idDomaine" hidden>
...
@section("script")
    <script>
        ...
        updateDomaine=function(id,name){
            $("#submitDomaineButton").text("Modifier");
            document.getElementById("formDomaine").action="/domaine/update";
            document.getElementById("id").value=id;
            document.getElementById("name").value=name;
        }
        createDomaine=function()
        {   $("#submitDomaineButton").text("Ajouter");
            document.getElementById("formDomaine").action="/domaine/create";
