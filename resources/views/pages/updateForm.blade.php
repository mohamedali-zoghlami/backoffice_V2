...
<div class="page-content">
    <div class="container-fluid">
        <div id="errorsMessage" class="alert alert-danger text-center" style="display: none">
                ...
                <form id="createFormForm" action="{{route('formulaire.update')}}" method="POST">
                    @csrf
                        ...
                        <div class="row d-flex justify-content-around">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="name" type="text" class="form-control" name="name" maxlength="255" value="{{$form->name}}" required autofocus>
                                </div>
                            </div>
                            <div class="col-md-6">
                                        <div class="form-group">
                            ...
                            <input id="id" name="id" value="{{$form->id}}" hidden>
                            <div class="col-md-4">
                                <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="visibility" id="visibility" class="form-control" disabled required="required">
                            ...
                            <input hidden name="visibility" value="{{$form->visibility}}">
                            <!-- liste des fiches -->
                        ...
                        <div class="row">
                            <div id="fb-editor"></div>
                                <div class="card-footer text-right" id="fb-editor-footer">
                                    <button id="saveForm"  class="btn btn-danger">Mettre à jour la formulaire</button>
                                </div>
                        </div>
...
var builder = Formio.builder(document.getElementById('fb-editor'),JSON.parse(form.formJson), {
    display:"form",noDefaultSubmitButton: true, builder: {
        ...
        console.log(formTemplateToSave)
